...
<center><img src="CPU.jpg" width="700" height="696" /></center>
<H1>1. Kerusakan Pada Mother Board </H1>
<font color="blue"<H1>Gejala :</font></H1>
Setelah dihidupkan, tidak ada tampilan di monitor, lampu indikator (led) di panel depan menyala, lampu indikator (led) monitor berkedip-kedip, kipas power supply dan kipas procesor berputar, tidak ada suara beep di speaker.
<font color="blue"<H1>Solusi :</font></H1>
...
<H1>2. Kerusakan Pada Power Supply</H1> 
<font color="blue"<H1> Gejala : </font></H1>
...
<font color="blue"<H1> Solusi :</font></H1>
Periksalah apakah kabel terhubung dengan benar dan steker terpasang dengan baik pada soketnya, periksa juga apakah ada tombol on/off dibelakang tepatnya dibelakang Power Supply sudah dalam posisi On, Jika sudah yakin terpasang dengan benar tapi tetap tidak ada respon untuk meyakinkan silahkan anda ganti kabel power dengan yang anda yakini bagus. Masalah terjadi karena tidak adanya tegangan listrik yang masuk, kerusakan ada pada kabel
<font color="blue"<H1>Masalah :</font></H1>
...
<H1>3. Kerusakan Pada Harddisk</H1>
<font color="blue"<H1>Gejala :</font></H1>
